...
df = pd.read_csv("New_Drug_Breast_Cancer_Data.csv")
print(df.head())
...
user_df = pd.read_csv("sample_user_upload_data_1.csv")
print(user_df.head())
...
model.save('LATEST_PREDICTION.h5')

print(prediction_df)
prediction_df.to_csv('user_prediction_result.csv')
